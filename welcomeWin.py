...
from listWin import Ui_listWin
...
class Ui_welcomeWin(object):
    ...
    def setupUi(self, welcomeWin):
        ...
        welcomeWin.setMinimumSize(QtCore.QSize(400, 280))
        ...
        self.pushButton = QtWidgets.QPushButton(self.verticalFrame , clicked = lambda: self.openWindow())
    ...
    def retranslateUi(self, welcomeWin):
        ...
        self.label_3.setText(_translate("welcomeWin", "welcome to Versatile app\nby Sajjad Rezvani.K for TNM\n"
